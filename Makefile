...
export DOCKER_IMAGE_BASE ?= openhorizon/edge-ai
...
check:
	...
	@echo "====================="
	@echo "DOCKER_IMAGE_BASE    default: openhorizon/edge-ai        actual: ${DOCKER_IMAGE_BASE}"
	...
	@echo "DOCKER_HUB_ID        default: openhorizon                actual: ${DOCKER_HUB_ID}"
...
run: stop
	@docker run -d \
		...
		-v $(DOCKER_VOLUME_NAME):/var/lib/edge-ai \
		-p 8080:8080 \
